...
$(document).ready(function() {
  ...
  (function() {
    $('.arrow').hover(
      function() {
        $('.banner, .titleb').fadeIn(200);
      },
      function() {
        $('.banner, .titleb').fadeOut(200);
      }
    );

    $('.arrow-next').hover(
      function() {
        $('.banner2, .titlea').fadeIn(200);
      },
      function() {
        $('.banner2, .titlea').fadeOut(200);
      }
    );
  })();
